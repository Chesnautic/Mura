...
import { COLORS, ColorSwatchButton, PillButton } from "./ui";

/** Palette controls, pulled out of ColorStudioScreen.tsx (the full-screen
 * mobile version) the same way WaveformExplorer/IconDropExplorer were -- so
 * it can also live inline in the desktop layout's right-hand panel. */
