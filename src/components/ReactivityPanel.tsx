...
import { COLORS, PillButton, SliderRow } from "./ui";

/**
 * Reactivity tuning controls, pulled out of ReactivityScreen.tsx (the
 * full-screen mobile version) the same way WaveformExplorer/IconDropExplorer
 * were -- so it can also live inline in the desktop layout's right-hand
 * panel. Everything here maps 1:1 onto `ReactivityControls`
 * (src/audio/types.ts), applied identically in the live preview
 * (VisualizerCanvas.tsx) and export (frameCapture.ts).
 */
